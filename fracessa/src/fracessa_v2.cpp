...
fracessa_v2::fracessa_v2(const RationalMatrix& matrix, bool is_cs, bool with_candidates, bool exact, bool full_support, bool with_log, int matrix_id)
    : game_matrix_(matrix)
...
void fracessa_v2::search_one_support(const bitset64& support, size_t support_size, bool is_cs_and_coprime)
{
